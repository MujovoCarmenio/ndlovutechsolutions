...
async function image(client, argv, telemetry) {
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-OTCUUI4L.js")).default(client, args, telemetry);
    case "inspect":
      return (await import("./inspect-NADJYMSZ.js")).default(client, args, telemetry);
    case "rm":
      return (await import("./rm-Q7VXI345.js")).default(client, args, telemetry);
    default:
