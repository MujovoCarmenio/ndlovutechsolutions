...
async function permissions(client, argv, telemetry) {
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-QBKFZC52.js")).default(client, argv, telemetry);
    case "add":
      return (await import("./add-USFLACJX.js")).default(client, argv, telemetry);
    case "rm":
      return (await import("./rm-P2ILGP4I.js")).default(client, argv, telemetry);
    case "clear":
      return (await import("./clear-ERVHWAHX.js")).default(client, argv, telemetry);
    default:
